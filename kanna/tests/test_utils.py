...
class TestToDict(unittest.TestCase):
    ...
    def test_builtin_value(self):
        ...
        actual = utils.to_dict(Foo(string=expected))
    ...
    def test_datetime_value(self):
        ...
        actual = utils.to_dict(Foo(dt=expected))
    ...
    def test_geopt_value(self):
        ...
        actual = utils.to_dict(Foo(geopt=expected))
    ...
    def test_blobkey_value(self):
        ...
        actual = utils.to_dict(Foo(blobkey=blobstore.BlobKey(expected)))
    ...
    def test_key_value(self):
        ...
        actual = utils.to_dict(Foo(ndbkey=ndb_key))
